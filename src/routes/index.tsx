...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";import { Card } from "@/components/ui/card";
            ...
            {whyUs.map((w) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">{w.desc}</p>                </div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container-x">
          <div className="relative overflow-hidden rounded-4xl gradient-primary p-8 text-primary-foreground shadow-elegant md:p-12">
            ...
            <div className="relative grid gap-8 md:grid-cols-2 md:items-center">              <div>
